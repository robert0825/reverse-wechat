...
public class j<K, V>
{
  ...
  {
    paramInt = (paramInt << 1) + 1;
    Object localObject = this.vC[paramInt];
    this.vC[paramInt] = paramV;
    return (V)localObject;
  }
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes-dex2jar.jar!\android\support\v4\e\j.class
