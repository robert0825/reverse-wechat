...
public class ContentFrameLayout
  extends FrameLayout
{
  public TypedValue PH;
  public TypedValue PI;
  public TypedValue PJ;
  public TypedValue PK;
  public TypedValue PL;
  public TypedValue PM;
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (i > 0)
      {
        m = View.MeasureSpec.makeMeasureSpec(Math.min(i - (this.PN.left + this.PN.right), View.MeasureSpec.getSize(paramInt1)), 1073741824);
        k = 1;
      }
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          i = paramInt2;
          if (paramInt1 > 0) {
            i = View.MeasureSpec.makeMeasureSpec(Math.min(paramInt1 - (this.PN.top + this.PN.bottom), View.MeasureSpec.getSize(paramInt2)), 1073741824);
          }
          super.onMeasure(m, i);
          i2 = getMeasuredWidth();
          ...
          for (;;)
          {
            ...
            paramInt2 = paramInt1;
            if (paramInt1 > 0) {
              paramInt2 = paramInt1 - (this.PN.left + this.PN.right);
            }
            if (i2 < paramInt2) {
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes-dex2jar.jar!\android\support\v7\widget\ContentFrameLayout.class
