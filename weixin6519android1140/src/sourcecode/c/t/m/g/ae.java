...
{
  private static u i = new u("direct_ip_black_list");
  public String a;
  private boolean b;
  private boolean c;
  private int d;
  ...
  public ae(URL paramURL, String paramString, r paramr)
  {
    if (u.a("direct_access_use_schedule", 0, 1, 1) == 1) {}
    for (boolean bool1 = true;; bool1 = false)
    {
      this.b = bool1;
      bool1 = bool2;
      if (u.a("direct_https_use_sche", 0, 1, 1) == 1) {
        bool1 = true;
      }
      this.c = bool1;
      this.d = u.a("direct_access_domain_try_times", 1, 8, 2);
      this.a = "";
      this.e = paramURL;
      this.f = paramString;
      this.h = paramr;
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes-dex2jar.jar!\c\t\m\g\ae.class
