...
public class Grammar
{
  ...
  private String a()
  {
    ...
    for (;;)
    {
      if (i >= this.e.size())
      {
        ...
        ((d)this.e.get(i)).aDp = a(((d)this.e.get(i)).userName);
        ((d)this.e.get(i)).aDq = a(((d)this.e.get(i)).aDn);
        ((d)this.e.get(i)).aDr = a(((d)this.e.get(i)).aDo);
        i += 1;
        break;
      }
      String str = ((d)this.e.get(i)).aDp;
      if (!str.isEmpty())
      {
  ...
  public int getResult(a parama)
  {
    ...
    for (;;)
    {
      ...
      if (((d)this.e.get(j)).aDp.compareTo(this.b.name) == 0)
      {
        parama.name = ((d)this.e.get(j)).userName;
        return 0;
      }
      if (((d)this.e.get(j)).aDq.compareTo(this.b.name) == 0)
      {
        parama.name = ((d)this.e.get(j)).userName;
        return 0;
      }
      if (((d)this.e.get(j)).aDr.compareTo(this.b.name) == 0)
      {
        parama.name = ((d)this.e.get(j)).userName;
        return 0;
      }
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes3-dex2jar.jar!\com\qq\wx\voice\embed\recognizer\Grammar.class
