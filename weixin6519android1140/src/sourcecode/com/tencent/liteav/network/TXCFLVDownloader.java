  ...
  extends TXIStreamDownloader
{
  ...
  private native long nativeInitFlvHander(String paramString, int paramInt);
  ...
  public void onRecvVideoData(byte[] paramArrayOfByte, int paramInt, long paramLong1, long paramLong2)
  {
    ...
    super.onRecvVideoData(paramArrayOfByte, paramInt, paramLong1, paramLong2);
  }
  ...
  public void startDownload(Vector<TXCStreamPlayUrl> paramVector, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    this.mPlayUrl = ((TXCStreamPlayUrl)paramVector.get(0)).strStreamUrl;
