...
public class Mars
{
  ...
  public static void checkLoadedModules(ArrayList<String> paramArrayList, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        w.i(paramString, "loaded modules: " + Arrays.toString(paramArrayList.toArray(arrayOfString)));
  ...
  {
    PlatformComm.init(paramContext, paramae);
    hasInitialized = true;
  }
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes-dex2jar.jar!\com\tencent\mars\Mars.class
