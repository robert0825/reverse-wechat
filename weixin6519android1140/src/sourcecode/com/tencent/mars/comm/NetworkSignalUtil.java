...
public class NetworkSignalUtil
{
  ...
  public static long getWifiSignalStrength()
  {
    ...
    if ((localWifiInfo != null) && (localWifiInfo.getBSSID() != null))
    {
      ...
      w.v("MicroMsg.NetworkSignalUtil", "Wifi Signal:" + j * 10);
      int i = j;
      if (j > 10) {
        i = 10;
      }
    ...
    w.v("MicroMsg.NetworkSignalUtil", "Can Not Get Wifi Signal");
    return 0L;
  }
}


/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes-dex2jar.jar!\com\tencent\mars\comm\NetworkSignalUtil.class
