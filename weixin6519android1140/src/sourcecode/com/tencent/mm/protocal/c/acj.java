  ...
  extends azh
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.tNl != null)
      {
        paramVarArgs.fm(2, this.tNl.aYq());
    ...
    if (paramInt == 1)
    {
      ...
      i = paramInt;
      if (this.tNl != null) {
        i = paramInt + b.a.a.a.fj(2, this.tNl.aYq());
      }
      GMTrace.o(3634750291968L, 27081);
      return i;
    }
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes3-dex2jar.jar!\com\tencent\mm\protocal\c\acj.class
