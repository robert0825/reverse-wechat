  ...
  extends azh
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.tUU != null)
      {
        paramVarArgs.fm(5, this.tUU.aYq());
    ...
    if (paramInt == 1)
    {
      ...
      paramInt = i;
      if (this.uuQ != null) {
        paramInt = i + b.a.a.b.b.a.f(2, this.uuQ);
      }
      i = paramInt;
      if (this.tUT != null) {
      ...
      i = paramInt;
      if (this.tUU != null) {
        i = paramInt + b.a.a.a.fj(5, this.tUU.aYq());
      }
      GMTrace.o(3655554039808L, 27236);
      return i;
    }
    ...
    if (paramInt == 3)
    {
      ...
      case 1: 
        ...
        while (paramInt < i)
        {
          ...
          localafd.uND = ((es)localObject1);
          paramInt += 1;
        }
        GMTrace.o(3655554039808L, 27236);
        return 0;
      case 2: 
        localafd.uuQ = ((b.a.a.a.a)localObject1).yqV.readString();
        GMTrace.o(3655554039808L, 27236);
        return 0;
      case 3: 
        paramVarArgs = ((b.a.a.a.a)localObject1).Gv(paramInt);
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes-dex2jar.jar!\com\tencent\mm\protocal\c\afd.class
