    ...
    for (paramInt = b.a.a.b.b.a.f(1, this.tVN) + 0;; paramInt = 0)
    {
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          ...
          return -1;
        case 1: 
          localahp.tVN = locala.yqV.readString();
          GMTrace.o(3994051149824L, 29758);
          return 0;
        }
        localahp.oqQ = locala.yqV.readString();
        GMTrace.o(3994051149824L, 29758);
        return 0;
      }
      GMTrace.o(3994051149824L, 29758);
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes-dex2jar.jar!\com\tencent\mm\protocal\c\ahp.class
