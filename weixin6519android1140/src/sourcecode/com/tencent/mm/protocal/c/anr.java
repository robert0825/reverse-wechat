    ...
    for (paramInt = b.a.a.b.b.a.f(1, this.lPM) + 0;; paramInt = 0)
    {
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          ...
          return -1;
        case 1: 
          localanr.lPM = locala.yqV.readString();
          GMTrace.o(3647635193856L, 27177);
          return 0;
        }
        localanr.jib = locala.yqV.nj();
        GMTrace.o(3647635193856L, 27177);
        return 0;
      }
      GMTrace.o(3647635193856L, 27177);
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes2-dex2jar.jar!\com\tencent\mm\protocal\c\anr.class
