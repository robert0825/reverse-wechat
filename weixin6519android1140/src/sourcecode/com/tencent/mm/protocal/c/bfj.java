  ...
  extends azh
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.uRi != null)
      {
        paramVarArgs.fm(2, this.uRi.aYq());
        this.uRi.a(paramVarArgs);
      }
    ...
    if (paramInt == 1)
    {
      ...
      i = paramInt;
      if (this.uRi != null) {
        i = paramInt + b.a.a.a.fj(2, this.uRi.aYq());
      }
      GMTrace.o(3921439358976L, 29217);
      return i;
    }
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes2-dex2jar.jar!\com\tencent\mm\protocal\c\bfj.class
