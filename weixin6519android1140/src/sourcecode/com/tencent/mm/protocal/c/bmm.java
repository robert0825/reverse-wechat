  ...
  extends azh
{
  ...
  protected final int a(int paramInt, Object... paramVarArgs)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.udz != null)
      {
        paramVarArgs.fm(2, this.udz.aYq());
    ...
    if (paramInt == 1)
    {
      ...
      i = paramInt;
      if (this.udz != null) {
        i = paramInt + b.a.a.a.fj(2, this.udz.aYq());
      }
      GMTrace.o(3734742499328L, 27826);
      return i;
    }
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes-dex2jar.jar!\com\tencent\mm\protocal\c\bmm.class
