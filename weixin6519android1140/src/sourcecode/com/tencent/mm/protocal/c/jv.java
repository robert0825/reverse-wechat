    ...
    for (paramInt = b.a.a.b.b.a.f(1, this.jxF) + 0;; paramInt = 0)
    {
      ...
      if (paramInt == 3)
      {
        ...
        default: 
          ...
          return -1;
        case 1: 
          localjv.jxF = locala.yqV.readString();
          GMTrace.o(3897817038848L, 29041);
          return 0;
        }
        localjv.code = locala.yqV.readString();
        GMTrace.o(3897817038848L, 29041);
        return 0;
      }
      GMTrace.o(3897817038848L, 29041);
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes2-dex2jar.jar!\com\tencent\mm\protocal\c\jv.class
