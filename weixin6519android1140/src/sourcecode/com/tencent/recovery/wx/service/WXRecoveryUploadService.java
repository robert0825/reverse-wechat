  ...
  extends RecoveryUploadService
{
  ...
  private boolean pushData(JSONArray paramJSONArray, String paramString)
  {
    try
    {
      Object localObject1 = WXUtil.fU(this);
  ...
  protected boolean tryToUploadData()
  {
    ...
    if ((((List)localObject).size() == 0) || (bool)) {
      RecoveryReporter.bt(this, "HandleStatus");
    }
    return bool;
  }
  ...
  protected boolean uploadData(List<RecoveryHandleItem> paramList)
  {
    ...
    Object localObject1 = "0x26051334";
    ...
    for (;;)
    {
      try
      {
        localJSONArray.put(new JSONObject().put("tag", "RecoveryHandle").put("info", ((RecoveryHandleItem)localObject2).amf).put("uin", ((RecoveryHandleItem)localObject2).lOv).put("deviceUUID", i).put("time", Util.fp(((RecoveryHandleItem)localObject2).timestamp)).put("cver", ((RecoveryHandleItem)localObject2).clientVersion).put("processName", ((RecoveryHandleItem)localObject2).processName).put("phoneStatus", ((RecoveryHandleItem)localObject2).xPJ));
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes-dex2jar.jar!\com\tencent\recovery\wx\service\WXRecoveryUploadService.class
