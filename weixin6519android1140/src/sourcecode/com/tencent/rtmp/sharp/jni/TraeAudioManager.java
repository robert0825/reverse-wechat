  ...
  extends BroadcastReceiver
{
  ...
  public BluetoohHeadsetCheckInterface CreateBluetoothCheck(Context paramContext, DeviceConfigManager paramDeviceConfigManager)
  {
    ...
    for (paramContext = "Y";; paramContext = "N")
    {
      ...
      return (BluetoohHeadsetCheckInterface)localObject2;
      if (Build.VERSION.SDK_INT != 18)
      {
  ...
  int InternalNotifyDeviceListUpdate()
  {
    ...
    final Object localObject = this._deviceConfigManager.getSnapParams();
    ...
    new Handler(Looper.getMainLooper()).post(new Runnable()
    {
      public void run()
      {
        ...
        localIntent.putExtra("EXTRA_DATA_PREV_CONNECTEDDEVICE", localObject);
  ...
  class DeviceConfigManager
  {
    ...
    public String getAvailabledHighestPriorityDevice()
    {
      ...
      for (;;)
      {
        ...
        this.mLock.unlock();
        if (localObject1 != null) {
          return ((DeviceConfig)localObject1).getDeviceName();
        }
    ...
    extends Thread
  {
    ...
    public TraeAudioManagerLooper(TraeAudioManager paramTraeAudioManager)
    {
      ...
      //   9: aload_0
      //   10: aconst_null
      //   11: putfield 93	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:mMsgHandler	Landroid/os/Handler;
      //   14: aload_0
      //   15: aconst_null
      //   16: putfield 95	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:_ringPlayer	Lcom/tencent/rtmp/sharp/jni/TraeMediaPlayer;
      //   19: aload_0
      //   20: ldc2_w 96
      //   23: putfield 99	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:_ringSessionID	J
      //   26: aload_0
      //   27: ldc 101
      //   29: putfield 103	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:_ringOperation	Ljava/lang/String;
      //   32: aload_0
      //   33: ldc 101
      //   35: putfield 105	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:_ringUserdata	Ljava/lang/String;
      //   38: aload_0
      //   39: iconst_1
      ...
      //   44: iconst_0
      //   45: bastore
      //   46: putfield 107	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:_started	[Z
      //   49: aload_0
      //   50: iconst_0
      //   51: putfield 109	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:_enabled	Z
      //   54: aload_0
      //   55: aconst_null
      //   56: putfield 111	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:_parent	Lcom/tencent/rtmp/sharp/jni/TraeAudioManager;
      //   59: aload_0
      //   60: ldc 101
      //   62: putfield 113	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:_lastCfg	Ljava/lang/String;
      //   65: aload_0
      //   66: iconst_0
      //   67: putfield 115	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:_preServiceMode	I
      //   70: aload_0
      //   71: iconst_0
      //   72: putfield 117	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:_preRingMode	I
      //   75: aload_0
      //   76: ldc2_w 96
      //   79: putfield 119	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:_voiceCallSessionID	J
      //   82: aload_0
      //   83: ldc 101
      //   85: putfield 121	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:_voiceCallOperation	Ljava/lang/String;
      //   88: aload_0
      //   89: aconst_null
      //   90: putfield 123	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:mAudioFocusChangeListener	Landroid/media/AudioManager$OnAudioFocusChangeListener;
      //   93: aload_0
      //   94: iconst_0
      //   95: putfield 125	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:_focusSteamType	I
      //   98: aload_0
      //   99: aload_2
      //   100: putfield 111	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:_parent	Lcom/tencent/rtmp/sharp/jni/TraeAudioManager;
      //   103: invokestatic 131	android/os/SystemClock:elapsedRealtime	()J
      //   106: lstore_3
      //   107: invokestatic 137	com/tencent/rtmp/sharp/jni/QLog:isColorLevel	()Z
      //   110: ifeq +11 -> 121
      //   113: ldc -117
      //   115: iconst_2
      //   116: ldc -115
      //   118: invokestatic 145	com/tencent/rtmp/sharp/jni/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
      //   121: aload_0
      //   122: invokevirtual 148	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:start	()V
      //   125: aload_0
      //   126: getfield 107	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:_started	[Z
      //   129: astore_1
      //   130: aload_1
      //   131: monitorenter
      //   132: aload_0
      //   133: getfield 107	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:_started	[Z
      //   136: iconst_0
      //   137: baload
      //   138: istore 5
      //   140: iload 5
      //   142: ifne +10 -> 152
      //   145: aload_0
      //   146: getfield 107	com/tencent/rtmp/sharp/jni/TraeAudioManager$TraeAudioManagerLooper:_started	[Z
      //   149: invokevirtual 153	java/lang/Object:wait	()V
      //   152: aload_1
      //   153: monitorexit
      //   154: invokestatic 137	com/tencent/rtmp/sharp/jni/QLog:isColorLevel	()Z
      //   157: ifeq +34 -> 191
      //   160: ldc -117
      //   162: iconst_2
      ...
      //   172: invokestatic 131	android/os/SystemClock:elapsedRealtime	()J
      //   175: lload_3
      //   176: lsub
      ...
      //   188: invokestatic 145	com/tencent/rtmp/sharp/jni/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
      //   191: return
      //   192: astore_2
      //   193: aload_1
      //   194: monitorexit
      ...
      //   0	201	0	this	TraeAudioManagerLooper
      //   0	201	1	this$1	TraeAudioManager
      //   0	201	2	paramTraeAudioManager	TraeAudioManager
      //   106	70	3	l	long
      //   138	3	5	i	int
      // Exception table:
      //   from	to	target	type
      ...
      //   152	154	192	finally
      //   193	195	192	finally
      //   145	152	197	java/lang/InterruptedException
    }
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes3-dex2jar.jar!\com\tencent\rtmp\sharp\jni\TraeAudioManager.class
