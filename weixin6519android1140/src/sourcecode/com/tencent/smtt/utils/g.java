...
public final class g
{
  public static String a(String paramString, byte[] paramArrayOfByte, a parama, boolean paramBoolean)
  {
    ...
    try
    {
      String str = k.cpl().cpn();
      str = paramString + str;
      if (paramBoolean) {}
      try
      {
        paramString = a.l(k.cpl().xYG.getBytes(), paramArrayOfByte);
      ...
      do
      {
        ...
        str = j.cpj();
        break;
        paramString = j.cpi().bF(paramArrayOfByte);
        paramArrayOfByte = paramString;
        break label53;
  ...
  public static String a(HttpURLConnection paramHttpURLConnection, a parama, boolean paramBoolean)
  {
    ...
    //   184: aload 4
    //   186: areturn
    //   187: invokestatic 55	com/tencent/smtt/utils/j:cpi	()Lcom/tencent/smtt/utils/j;
    //   190: pop
    //   191: new 39	java/lang/String
    //   194: dup
    //   195: aload_1
    //   196: invokevirtual 154	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   199: invokestatic 162	com/tencent/smtt/utils/j:bG	([B)[B
  ...
  /* Error */
  public static HttpURLConnection q(String paramString, Map<String, String> paramMap)
  {
    // Byte code:
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes2-dex2jar.jar!\com\tencent\smtt\utils\g.class
