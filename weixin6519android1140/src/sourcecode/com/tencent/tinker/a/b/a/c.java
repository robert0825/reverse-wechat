  ...
  extends e
{
  ...
  private void FE(int paramInt)
  {
    b localb;
    int i;
    if (paramInt != this.ydQ)
    {
      localb = this.ydP;
      i = this.ydQ;
      if ((localb.mSize != 0) && (paramInt <= localb.vD[(localb.mSize - 1)])) {
    ...
    localb.vD = b.c(localb.vD, localb.mSize, paramInt);
    localb.ydZ = b.c(localb.ydZ, localb.mSize, i);
    localb.mSize += 1;
  }
  
  public final int FF(int paramInt)
  {
    int i = this.ydP.indexOfKey(paramInt);
    if (i < 0) {
      return paramInt;
    }
    return this.ydP.ydZ[i];
  }
  ...
  public final void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, long paramLong)
  {
    ...
    {
    default: 
      throw new IllegalStateException("unexpected opcode: " + a.FI(paramInt2));
    case -1: 
    case 0: 
    case 14: 
      this.ydQ += 1;
  ...
  public final void a(int paramInt1, int paramInt2, Object paramObject, int paramInt3, int paramInt4)
  {
    ...
    case 7: 
    default: 
      throw new j("bogus element_width: " + a.FH(paramInt4));
    case 1: 
      paramInt1 = ((byte[])paramObject).length;
      this.ydQ = ((paramInt1 & 0x1) + (paramInt1 >> 1) + this.ydQ);
      return;
    case 2: 
      this.ydQ += ((short[])paramObject).length * 1;
      return;
    case 4: 
      this.ydQ += ((int[])paramObject).length * 2;
      return;
    }
    this.ydQ += ((long[])paramObject).length * 4;
  }
  ...
  public final void a(int paramInt1, int paramInt2, int[] paramArrayOfInt1, int[] paramArrayOfInt2)
  {
    FE(paramInt1);
    this.ydQ += 2;
    this.ydQ += paramArrayOfInt1.length * 2;
    this.ydQ += paramArrayOfInt2.length * 2;
  }
  ...
  public final void b(int paramInt1, int paramInt2, int paramInt3, int[] paramArrayOfInt)
  {
    FE(paramInt1);
    this.ydQ += 4;
    this.ydQ += paramArrayOfInt.length * 2;
  }
}


/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes3-dex2jar.jar!\com\tencent\tinker\a\b\a\c.class
