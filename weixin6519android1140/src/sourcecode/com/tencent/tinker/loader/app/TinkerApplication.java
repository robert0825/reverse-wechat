  ...
  extends Application
{
  ...
  private void onBaseContextAttached(Context paramContext)
  {
    ...
    if (this.useSafeMode)
    {
      paramContext = ShareTinkerInternals.ii(this);
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes-dex2jar.jar!\com\tencent\tinker\loader\app\TinkerApplication.class
