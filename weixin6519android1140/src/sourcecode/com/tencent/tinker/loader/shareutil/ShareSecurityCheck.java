...
{
  private static String yiU = null;
  private final Context mContext;
  public final HashMap<String, String> yiV;
  private final HashMap<String, String> yiW;
  
  public ShareSecurityCheck(Context paramContext)
  {
    this.mContext = paramContext;
    this.yiV = new HashMap();
    ...
    if (yiU == null)
    {
      ...
      try
      {
        paramContext = SharePatchFileUtil.bK(paramContext.getPackageManager().getPackageInfo(paramContext.getPackageName(), 64).signatures[0].toByteArray());
        yiU = paramContext;
  ...
  private static boolean a(File paramFile, Certificate[] paramArrayOfCertificate)
  {
    if (paramArrayOfCertificate.length > 0)
    {
      ...
      while (i >= 0) {
        try
        {
          boolean bool = yiU.equals(SharePatchFileUtil.bK(paramArrayOfCertificate[i].getEncoded()));
          if (bool) {
            return true;
          }
        }
  ...
  /* Error */
  public final boolean af(File paramFile)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokestatic 107	com/tencent/tinker/loader/shareutil/SharePatchFileUtil:Z	(Ljava/io/File;)Z
    //   4: ifne +5 -> 9
    //   7: iconst_0
    //   8: ireturn
    ...
    //   74: ifeq -49 -> 25
    //   77: aload_0
    //   78: getfield 30	com/tencent/tinker/loader/shareutil/ShareSecurityCheck:yiV	Ljava/util/HashMap;
    //   81: aload 6
    //   83: aload 4
    //   85: aload 5
  ...
  public final HashMap<String, String> cqL()
  {
    if (!this.yiW.isEmpty()) {
      return this.yiW;
    }
    Object localObject = (String)this.yiV.get("assets/package_meta.txt");
    if (localObject == null) {
      return null;
    }
    ...
    while (i < j)
    {
      ...
      if ((arrayOfString != null) && (arrayOfString.length() > 0) && (!arrayOfString.startsWith("#")))
      {
        ...
        if ((arrayOfString != null) && (arrayOfString.length >= 2)) {
          this.yiW.put(arrayOfString[0].trim(), arrayOfString[1].trim());
        }
      }
      i += 1;
    }
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes-dex2jar.jar!\com\tencent\tinker\loader\shareutil\ShareSecurityCheck.class
