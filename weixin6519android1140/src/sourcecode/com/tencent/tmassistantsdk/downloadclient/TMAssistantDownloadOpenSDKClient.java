  ...
  extends TMAssistantDownloadSDKClientBase
{
  ...
  public byte[] sendSyncData(byte[] paramArrayOfByte)
  {
    if (!TextUtils.isEmpty(this.mClientKey))
    {
      a locala = (a)super.getServiceInterface();
      if (locala != null) {
        return locala.b(this.mClientKey, paramArrayOfByte);
      }
    }
    return null;
  }
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes3-dex2jar.jar!\com\tencent\tmassistantsdk\downloadclient\TMAssistantDownloadOpenSDKClient.class
