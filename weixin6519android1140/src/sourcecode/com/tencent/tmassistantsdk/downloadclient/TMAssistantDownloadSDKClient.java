  ...
  extends TMAssistantDownloadSDKClientBase
{
  ...
  public int startDownloadTask(String paramString1, String paramString2)
  {
    try
    {
      int i = startDownloadTask(paramString1, "", 0L, 0, paramString2, null, null);
      return i;
    }
    finally
    {
  ...
  public int startDownloadTask(String paramString1, String paramString2, long paramLong, int paramInt, String paramString3, String paramString4, Map<String, String> paramMap)
  {
    try
    {
  ...
  public int startDownloadTask(String paramString1, String paramString2, String paramString3)
  {
    try
    {
      int i = startDownloadTask(paramString1, "", 0L, 0, paramString2, paramString3, null);
      return i;
    }
    finally
    {
  ...
  public int startDownloadTask(String paramString1, String paramString2, Map<String, String> paramMap)
  {
    try
    {
      int i = startDownloadTask(paramString1, "", 0L, 0, paramString2, null, paramMap);
      return i;
    }
    finally
    {
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes3-dex2jar.jar!\com\tencent\tmassistantsdk\downloadclient\TMAssistantDownloadSDKClient.class
