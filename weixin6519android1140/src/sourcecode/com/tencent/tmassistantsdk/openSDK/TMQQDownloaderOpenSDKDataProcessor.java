  ...
  implements IAssistantOnActionListener
{
  ...
  public ArrayList<TMAssistantDownloadTaskInfo> getBatchTaskInfos(ArrayList<TMQQDownloaderOpenSDKParam> paramArrayList, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      {
        w.printErrStackTrace("QQDownloaderOpenSDKDataProcessor", paramArrayList, "", new Object[0]);
        return null;
      }
    }
    for (;;)
  ...
  public TMAssistantDownloadTaskInfo getDownloadTask(TMQQDownloaderOpenSDKParam paramTMQQDownloaderOpenSDKParam)
  {
    ...
    for (;;)
    {
      ...
      {
        w.printErrStackTrace("QQDownloaderOpenSDKDataProcessor", paramTMQQDownloaderOpenSDKParam, "", new Object[0]);
        return null;
      }
  ...
  public boolean handleUriAction(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((paramString != null) && (paramString.length > 0)) {
        ...
        {
          w.printErrStackTrace("QQDownloaderOpenSDKDataProcessor", paramString, "", new Object[0]);
          return false;
        }
      }
    }
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes3-dex2jar.jar!\com\tencent\tmassistantsdk\openSDK\TMQQDownloaderOpenSDKDataProcessor.class
