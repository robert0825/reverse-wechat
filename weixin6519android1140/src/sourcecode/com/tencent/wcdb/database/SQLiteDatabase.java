  ...
  extends SQLiteClosable
{
  ...
  private void beginTransaction(SQLiteTransactionListener paramSQLiteTransactionListener, boolean paramBoolean)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 155	com/tencent/wcdb/database/SQLiteDatabase:acquireReference	()V
    //   4: aload_0
    //   5: invokevirtual 159	com/tencent/wcdb/database/SQLiteDatabase:getThreadSession	()Lcom/tencent/wcdb/database/SQLiteSession;
    //   8: astore 4
    //   10: iload_2
    //   11: ifeq +23 -> 34
    //   14: iconst_2
    ...
    //   20: aload_0
    //   21: iconst_0
    //   22: invokevirtual 163	com/tencent/wcdb/database/SQLiteDatabase:getThreadDefaultConnectionFlags	(Z)I
    //   25: aconst_null
    //   26: invokevirtual 168	com/tencent/wcdb/database/SQLiteSession:beginTransaction	(ILcom/tencent/wcdb/database/SQLiteTransactionListener;ILcom/tencent/wcdb/support/CancellationSignal;)V
    //   29: aload_0
    //   30: invokevirtual 171	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   33: return
    //   34: iconst_1
    //   35: istore_3
    //   36: goto -20 -> 16
    //   39: astore_1
    //   40: aload_0
    //   41: invokevirtual 171	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   44: aload_1
    //   45: athrow
  ...
  public final int delete(String paramString1, String paramString2, String[] paramArrayOfString)
  {
    ...
    //   7: dup
    //   8: ldc_w 521
    //   11: invokespecial 396	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   14: aload_1
    //   15: invokevirtual 213	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   18: astore 5
    //   20: aload_2
    //   21: invokestatic 300	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   24: ifne +57 -> 81
    //   27: new 204	java/lang/StringBuilder
    //   30: dup
    //   31: ldc_w 523
    //   34: invokespecial 396	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   37: aload_2
    //   38: invokevirtual 213	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   41: invokevirtual 218	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   44: astore_1
    //   45: new 284	com/tencent/wcdb/database/SQLiteStatement
    //   48: dup
    //   49: aload_0
    //   50: aload 5
    //   52: aload_1
    ...
    //   59: aload_3
    //   60: invokespecial 287	com/tencent/wcdb/database/SQLiteStatement:<init>	(Lcom/tencent/wcdb/database/SQLiteDatabase;Ljava/lang/String;[Ljava/lang/Object;)V
    //   63: astore_1
    //   64: aload_1
    //   65: invokevirtual 525	com/tencent/wcdb/database/SQLiteStatement:executeUpdateDelete	()I
    //   68: istore 4
    //   70: aload_1
    //   71: invokevirtual 292	com/tencent/wcdb/database/SQLiteStatement:close	()V
    //   74: aload_0
    //   75: invokevirtual 171	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   78: iload 4
    //   80: ireturn
    //   81: ldc 101
    //   83: astore_1
    ...
    //   87: astore_2
    //   88: aload_1
    //   89: invokevirtual 292	com/tencent/wcdb/database/SQLiteStatement:close	()V
    //   92: aload_2
    //   93: athrow
    //   94: astore_1
    //   95: aload_0
    //   96: invokevirtual 171	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   99: aload_1
    //   100: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public final java.util.List<Pair<String, String>> getAttachedDbs()
  {
    ...
    //   3: dup
    //   4: invokespecial 314	java/util/ArrayList:<init>	()V
    //   7: astore_1
    //   8: aload_0
    //   9: getfield 134	com/tencent/wcdb/database/SQLiteDatabase:mLock	Ljava/lang/Object;
    //   12: astore_2
    //   13: aload_2
    //   14: monitorenter
    //   15: aload_0
    //   16: getfield 175	com/tencent/wcdb/database/SQLiteDatabase:mConnectionPoolLocked	Lcom/tencent/wcdb/database/SQLiteConnectionPool;
    //   19: ifnonnull +7 -> 26
    //   22: aload_2
    //   23: monitorexit
    //   24: aconst_null
    //   25: areturn
    //   26: aload_0
    //   27: getfield 279	com/tencent/wcdb/database/SQLiteDatabase:mHasAttachedDbsLocked	Z
    //   30: ifne +29 -> 59
    //   33: aload_1
    //   34: new 568	android/util/Pair
    //   37: dup
    //   38: ldc_w 570
    //   41: aload_0
    //   42: getfield 145	com/tencent/wcdb/database/SQLiteDatabase:mConfigurationLocked	Lcom/tencent/wcdb/database/SQLiteDatabaseConfiguration;
    //   45: getfield 573	com/tencent/wcdb/database/SQLiteDatabaseConfiguration:path	Ljava/lang/String;
    //   48: invokespecial 576	android/util/Pair:<init>	(Ljava/lang/Object;Ljava/lang/Object;)V
    //   51: invokevirtual 500	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   54: pop
    //   55: aload_2
    //   56: monitorexit
    //   57: aload_1
    //   58: areturn
    //   59: aload_0
    //   60: invokevirtual 155	com/tencent/wcdb/database/SQLiteDatabase:acquireReference	()V
    //   63: aload_2
    //   64: monitorexit
    //   65: aload_0
    //   66: ldc_w 578
    //   69: aconst_null
    //   70: invokevirtual 582	com/tencent/wcdb/database/SQLiteDatabase:rawQuery	(Ljava/lang/String;[Ljava/lang/String;)Lcom/tencent/wcdb/Cursor;
    //   73: astore_2
    //   74: aload_2
    //   75: invokeinterface 587 1 0
    //   80: ifeq +57 -> 137
    //   83: aload_1
    //   84: new 568	android/util/Pair
    //   87: dup
    //   88: aload_2
    //   89: iconst_1
    ...
    //   95: aload_2
    //   96: iconst_2
    //   97: invokeinterface 591 2 0
    //   102: invokespecial 576	android/util/Pair:<init>	(Ljava/lang/Object;Ljava/lang/Object;)V
    //   105: invokevirtual 500	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   108: pop
    //   109: goto -35 -> 74
    //   112: astore_1
    //   113: aload_2
    //   114: ifnull +9 -> 123
    //   117: aload_2
    //   118: invokeinterface 592 1 0
    //   123: aload_1
    //   124: athrow
    //   125: astore_1
    //   126: aload_0
    //   127: invokevirtual 171	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   130: aload_1
    //   131: athrow
    //   132: astore_1
    //   133: aload_2
    ...
    //   138: ifnull +9 -> 147
    //   141: aload_2
    //   142: invokeinterface 592 1 0
    //   147: aload_0
    //   148: invokevirtual 171	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   151: aload_1
    //   152: areturn
    //   153: astore_1
    //   154: aconst_null
  ...
  public final boolean isDatabaseIntegrityOk()
  {
    ...
    //   1: invokevirtual 155	com/tencent/wcdb/database/SQLiteDatabase:acquireReference	()V
    //   4: aload_0
    //   5: invokevirtual 697	com/tencent/wcdb/database/SQLiteDatabase:getAttachedDbs	()Ljava/util/List;
    //   8: astore_3
    //   9: aload_3
    //   10: ifnonnull +198 -> 208
    //   13: new 310	java/lang/IllegalStateException
    //   16: dup
    //   17: new 204	java/lang/StringBuilder
    //   20: dup
    //   21: ldc_w 699
    //   24: invokespecial 396	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   27: aload_0
    //   28: invokevirtual 700	com/tencent/wcdb/database/SQLiteDatabase:getPath	()Ljava/lang/String;
    ...
    //   40: invokevirtual 218	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   43: invokespecial 313	java/lang/IllegalStateException:<init>	(Ljava/lang/String;)V
    //   46: athrow
    //   47: astore_2
    //   48: new 253	java/util/ArrayList
    //   51: dup
    //   52: invokespecial 314	java/util/ArrayList:<init>	()V
    //   55: astore_3
    //   56: aload_3
    //   57: new 568	android/util/Pair
    //   60: dup
    //   61: ldc_w 570
    //   64: aload_0
    //   65: invokevirtual 700	com/tencent/wcdb/database/SQLiteDatabase:getPath	()Ljava/lang/String;
    //   68: invokespecial 576	android/util/Pair:<init>	(Ljava/lang/Object;Ljava/lang/Object;)V
    //   71: invokeinterface 705 2 0
    //   76: pop
    //   77: goto +172 -> 249
    //   80: iload_1
    //   81: aload_3
    //   82: invokeinterface 706 1 0
    //   87: if_icmpge +152 -> 239
    //   90: aload_3
    //   91: iload_1
    //   92: invokeinterface 709 2 0
    //   97: checkcast 568	android/util/Pair
    //   100: astore 4
    //   102: aload_0
    //   103: new 204	java/lang/StringBuilder
    //   106: dup
    //   107: ldc_w 711
    //   110: invokespecial 396	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   113: aload 4
    //   115: getfield 714	android/util/Pair:first	Ljava/lang/Object;
    //   118: checkcast 99	java/lang/String
    ...
    //   133: invokevirtual 718	com/tencent/wcdb/database/SQLiteDatabase:compileStatement	(Ljava/lang/String;)Lcom/tencent/wcdb/database/SQLiteStatement;
    //   136: astore_2
    //   137: aload_2
    //   138: invokevirtual 721	com/tencent/wcdb/database/SQLiteStatement:simpleQueryForString	()Ljava/lang/String;
    //   141: astore 5
    //   143: aload 5
    //   145: ldc_w 723
    //   148: invokevirtual 727	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   151: ifne +60 -> 211
    //   154: ldc 56
    //   156: new 204	java/lang/StringBuilder
    //   159: dup
    //   160: ldc_w 729
    //   163: invokespecial 396	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   166: aload 4
    //   168: getfield 732	android/util/Pair:second	Ljava/lang/Object;
    //   171: checkcast 99	java/lang/String
    //   174: invokevirtual 213	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   177: ldc_w 734
    //   180: invokevirtual 213	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   183: aload 5
    //   185: invokevirtual 213	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   188: invokevirtual 218	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   191: invokestatic 736	com/tencent/wcdb/support/Log:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   194: aload_2
    //   195: ifnull +7 -> 202
    //   198: aload_2
    //   199: invokevirtual 292	com/tencent/wcdb/database/SQLiteStatement:close	()V
    //   202: aload_0
    //   203: invokevirtual 171	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   206: iconst_0
    //   207: ireturn
    //   208: goto +41 -> 249
    //   211: aload_2
    //   212: ifnull +42 -> 254
    //   215: aload_2
    //   216: invokevirtual 292	com/tencent/wcdb/database/SQLiteStatement:close	()V
    //   219: goto +35 -> 254
    //   222: aload_2
    //   223: ifnull +7 -> 230
    //   226: aload_2
    //   227: invokevirtual 292	com/tencent/wcdb/database/SQLiteStatement:close	()V
    //   230: aload_3
    //   231: athrow
    //   232: astore_2
    //   233: aload_0
    //   234: invokevirtual 171	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   237: aload_2
    //   238: athrow
    //   239: aload_0
    //   240: invokevirtual 171	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   243: iconst_1
    //   244: ireturn
    //   245: astore_3
    //   246: goto -24 -> 222
  ...
  public final Cursor rawQueryWithFactory(CursorFactory paramCursorFactory, String paramString1, String[] paramArrayOfString, String paramString2, CancellationSignal paramCancellationSignal)
  {
    ...
    //   0: aload_0
    //   1: invokevirtual 155	com/tencent/wcdb/database/SQLiteDatabase:acquireReference	()V
    //   4: new 784	com/tencent/wcdb/database/SQLiteDirectCursorDriver
    //   7: dup
    //   8: aload_0
    //   9: aload_2
    //   10: aload 4
    //   12: aload 5
    //   14: invokespecial 787	com/tencent/wcdb/database/SQLiteDirectCursorDriver:<init>	(Lcom/tencent/wcdb/database/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Lcom/tencent/wcdb/support/CancellationSignal;)V
    //   17: astore_2
    //   18: aload_1
    //   19: ifnull +18 -> 37
    //   22: aload_2
    //   23: aload_1
    //   24: aload_3
    //   25: invokeinterface 792 3 0
    //   30: astore_1
    //   31: aload_0
    //   32: invokevirtual 171	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   35: aload_1
    //   36: areturn
    //   37: aload_0
    //   38: getfield 136	com/tencent/wcdb/database/SQLiteDatabase:mCursorFactory	Lcom/tencent/wcdb/database/SQLiteDatabase$CursorFactory;
    //   41: astore_1
    //   42: goto -20 -> 22
    //   45: astore_1
    //   46: aload_0
    //   47: invokevirtual 171	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   50: aload_1
    //   51: athrow
    // Local variable table:
    //   start	length	slot	name	signature
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes-dex2jar.jar!\com\tencent\wcdb\database\SQLiteDatabase.class
