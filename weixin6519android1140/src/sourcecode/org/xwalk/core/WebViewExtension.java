...
public class WebViewExtension
{
  ...
  public static WebViewExtensionListener mWebViewExtensionListener;
      ...
      mWebViewExtensionInterface = new WebViewExtensionInterface()
      {
        public final Object onMiscCallBack(String paramAnonymousString, Object... paramAnonymousVarArgs)
        {
          if (WebViewExtension.mWebViewExtensionListener != null) {
            return WebViewExtension.mWebViewExtensionListener.onMiscCallBack(paramAnonymousString, paramAnonymousVarArgs);
          }
          return null;
        }
      };
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes3-dex2jar.jar!\org\xwalk\core\WebViewExtension.class
