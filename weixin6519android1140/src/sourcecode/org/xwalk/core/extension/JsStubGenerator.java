...
public class JsStubGenerator
{
  ...
  String[] classGenerator(ReflectionHelper paramReflectionHelper)
  {
    ...
    {
      localObject1 = generateEventTarget(paramReflectionHelper);
      localObject2 = "" + (String)localObject1;
      localObject1 = "" + (String)localObject1;
    }
    Map localMap = paramReflectionHelper.getMembers();
    Iterator localIterator = localMap.keySet().iterator();
    paramReflectionHelper = (ReflectionHelper)localObject1;
    localObject1 = localObject2;
    localObject2 = paramReflectionHelper;
    while (localIterator.hasNext())
    {
      ...
      for (;;)
      {
        ...
        localObject2 = (String)localObject2 + paramReflectionHelper;
        break;
      ...
      label226:
      localObject1 = (String)localObject1 + paramReflectionHelper;
    }
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes3-dex2jar.jar!\org\xwalk\core\extension\JsStubGenerator.class
