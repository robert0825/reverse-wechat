  ...
  extends ContextWrapper
{
  ...
  public XWalkContextWrapper(Context paramContext, int paramInt)
  {
    ...
    XWalkLayoutInflaterFactory localXWalkLayoutInflaterFactory = new XWalkLayoutInflaterFactory();
  ...
  {
    // Byte code:
    //   0: getstatic 350	org/xwalk/core/resource/XWalkContextWrapper:mResourcessKeyIdMap	Ljava/util/HashMap;
    //   3: ifnull +13 -> 16
    //   6: getstatic 350	org/xwalk/core/resource/XWalkContextWrapper:mResourcessKeyIdMap	Ljava/util/HashMap;
    //   9: invokevirtual 355	java/util/HashMap:clone	()Ljava/lang/Object;
    //   12: checkcast 352	java/util/HashMap
    //   15: areturn
    //   16: ldc 16
    //   18: ldc_w 357
    //   21: invokestatic 253	org/xwalk/core/Log:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   24: new 352	java/util/HashMap
    //   27: dup
    //   28: invokespecial 358	java/util/HashMap:<init>	()V
    //   31: astore 10
    //   33: aload_0
    //   34: invokevirtual 359	org/xwalk/core/resource/XWalkContextWrapper:getClassLoader	()Ljava/lang/ClassLoader;
    //   37: ldc 13
    //   39: invokevirtual 365	java/lang/ClassLoader:loadClass	(Ljava/lang/String;)Ljava/lang/Class;
    //   42: invokevirtual 369	java/lang/Class:getClasses	()[Ljava/lang/Class;
    //   45: astore 11
    //   47: aload 11
    //   49: arraylength
    //   50: istore 6
    ...
    //   64: astore 12
    //   66: aload 12
    //   68: invokevirtual 372	java/lang/Class:getSimpleName	()Ljava/lang/String;
    //   71: ldc_w 374
    //   74: invokevirtual 378	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   77: ifeq +380 -> 457
    //   80: aload 12
    //   82: invokevirtual 382	java/lang/Class:getFields	()[Ljava/lang/reflect/Field;
    //   85: astore 12
    //   87: aload 12
    //   89: arraylength
    //   90: istore 7
    ...
    //   104: astore 13
    //   106: aload 13
    //   108: invokevirtual 385	java/lang/reflect/Field:getModifiers	()I
    //   111: invokestatic 391	java/lang/reflect/Modifier:isFinal	(I)Z
    //   114: ifeq +9 -> 123
    //   117: aload 13
    //   119: iconst_1
    ...
    //   126: iload 5
    //   128: istore 4
    //   130: new 393	android/util/TypedValue
    //   133: dup
    //   134: invokespecial 394	android/util/TypedValue:<init>	()V
    //   137: astore 14
    //   139: iload 5
    //   141: istore 4
    //   143: aload 13
    //   145: aconst_null
    //   146: invokevirtual 398	java/lang/reflect/Field:getInt	(Ljava/lang/Object;)I
    //   149: istore 5
    //   151: iload 5
    //   153: istore 4
    //   155: aload_1
    ...
    //   158: aload 14
    //   160: iconst_1
    //   161: invokevirtual 402	android/content/res/Resources:getValue	(ILandroid/util/TypedValue;Z)V
    //   164: iload 5
    //   166: istore 4
    //   168: aload 14
    //   170: getfield 405	android/util/TypedValue:assetCookie	I
    //   173: i2l
    //   174: bipush 32
    //   176: lshl
    //   177: aload 14
    //   179: getfield 408	android/util/TypedValue:data	I
    //   182: i2l
    //   183: lor
    //   184: lstore 8
    //   186: iload 5
    ...
    //   190: aload 10
    //   192: lload 8
    //   194: invokestatic 414	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   197: iload 5
    //   199: invokestatic 419	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   202: invokevirtual 423	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   205: pop
    //   206: iload 5
    //   208: istore 4
    //   210: ldc 16
    ...
    //   222: aload 13
    //   224: invokevirtual 428	java/lang/reflect/Field:getName	()Ljava/lang/String;
    ...
    //   236: iload 5
    //   238: invokevirtual 433	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   241: ldc_w 435
    //   244: invokevirtual 162	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   247: lload 8
    //   249: invokevirtual 438	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   252: invokevirtual 165	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   255: invokestatic 441	org/xwalk/core/Log:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   258: aload 13
    //   260: invokevirtual 385	java/lang/reflect/Field:getModifiers	()I
    //   263: invokestatic 391	java/lang/reflect/Modifier:isFinal	(I)Z
    //   266: ifeq +198 -> 464
    //   269: aload 13
    //   271: iconst_0
    ...
    //   285: dup
    //   286: invokespecial 442	java/lang/StringBuilder:<init>	()V
    //   289: aload 13
    //   291: invokevirtual 428	java/lang/reflect/Field:getName	()Ljava/lang/String;
    ...
    //   306: invokestatic 447	org/xwalk/core/Log:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   309: goto -51 -> 258
    //   312: astore_1
    //   313: ldc 16
    //   315: ldc_w 449
    ...
    //   321: aload 10
    //   323: putstatic 350	org/xwalk/core/resource/XWalkContextWrapper:mResourcessKeyIdMap	Ljava/util/HashMap;
    //   326: ldc 16
    //   328: new 149	java/lang/StringBuilder
    //   331: dup
    //   332: ldc_w 451
    //   335: invokespecial 154	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   338: getstatic 350	org/xwalk/core/resource/XWalkContextWrapper:mResourcessKeyIdMap	Ljava/util/HashMap;
    //   341: invokevirtual 455	java/util/HashMap:keySet	()Ljava/util/Set;
    //   344: invokeinterface 460 1 0
    //   349: invokevirtual 433	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    ...
    //   358: getstatic 350	org/xwalk/core/resource/XWalkContextWrapper:mResourcessKeyIdMap	Ljava/util/HashMap;
    //   361: invokevirtual 355	java/util/HashMap:clone	()Ljava/lang/Object;
    //   364: checkcast 352	java/util/HashMap
    //   367: areturn
    //   368: astore 14
    //   370: ldc 16
    //   372: new 149	java/lang/StringBuilder
    //   375: dup
    //   376: invokespecial 442	java/lang/StringBuilder:<init>	()V
    //   379: aload 13
    //   381: invokevirtual 428	java/lang/reflect/Field:getName	()Ljava/lang/String;
    ...
    //   396: invokestatic 447	org/xwalk/core/Log:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   399: goto -141 -> 258
    //   402: astore_1
    //   403: ldc 16
    //   405: aload_1
    ...
    //   422: dup
    //   423: invokespecial 442	java/lang/StringBuilder:<init>	()V
    //   426: aload 13
    //   428: invokevirtual 428	java/lang/reflect/Field:getName	()Ljava/lang/String;
    ...
    //   440: iload 4
    //   442: invokestatic 467	java/lang/Integer:toHexString	(I)Ljava/lang/String;
    ...
    //   451: invokestatic 447	org/xwalk/core/Log:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   454: goto -196 -> 258
    //   457: iload_2
    //   458: iconst_1
    //   459: iadd
    ...
    //   368	1	14	localIllegalArgumentException	IllegalArgumentException
  ...
  private static final class XWalkLayoutInflaterFactory
...
/* Location:              D:\tools\apktool\weixin6519android1140\jar\classes3-dex2jar.jar!\org\xwalk\core\resource\XWalkContextWrapper.class
